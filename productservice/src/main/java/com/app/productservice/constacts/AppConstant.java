package com.app.productservice.constacts;
...
public class AppConstant {
    ...
    public static final String APP_LOG_REQUEST = "REQUEST";
    public static final String APP_LOG_RESPONSE = "RESPONSE";
    public static final String APP_LOG_EXCEPTION = "EXCEPTION";
    ...
    public static final String APP_EXIST_INFO_CODE = "201";
    public static final String APP_SUCCESS_CODE = "200";
    public static final String APP_EXIST_CODE = "202";
    public static final String APP_NOT_ALLOW_CODE = "203";
    public static final String APP_NOT_LINK_CODE = "204";
    public static final String APP_DUPLICATE_EXIT = "205";
    public static final String APP_BADREQUEST_CODE = "400";
    public static final String APP_SERVER_ERROR_CODE = "500";
    public static final String APP_INVALID_FORMAT = "101";
    public static final String APP_SUCCESS_MESSAGE = "app.success.message";
    ...
    public static final String REGEX_BILLING = "^[0-9A-Za-z -a-à-ả-ãá-ạ-ă-ằ-ẳ-ẵ-ắ-ặ-â-ầ-ẩ-ẫ-ấ-ậ-b-c-d-đ-e-è-ẻ-ẽé-ẹê-ề-ể-ễế-ệ-f-g-h-i-ì-ỉ-ĩí-ị-j-k-l-m-n-o-ò-ỏ-õó-ọ-ô-ồ-ổ-ỗ-ố-ộ-ơ-ờ-ở-ỡ-ớ-ợ-p-q-r-s-t-u-ù-ủ-ũú-ụ-ư-ừ-ử-ữ-ứ-ựv-w-x-y-ỳ-ỷ-ỹý-ỵ-z0]*$";
    ...
    public static class IMAGE_TYPE {
        ...
        public static final String PAPER_PROVE = "paper";
    }
    ...
    public static final String VNPOST = "VNPOST";
    public static final String VNP = "VNP";

    /**
     * API PTF
     */
    public static final String PTF_API_NAPAS = "PTF_API_NAPAS";
    /**
     * API CONTACT
     */
